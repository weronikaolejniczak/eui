...
**EuiComboBoxList** uses [react-window](https://github.com/bvaughn/react-window) to only render visible options to be super fast no matter how many options there are.
...
## Custom options only, with validation[](/docs/forms/combo-box#custom-options-only-with-validation)
