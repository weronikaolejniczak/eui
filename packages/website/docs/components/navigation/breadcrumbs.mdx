...
import breadcrumbDocgen from '@elastic/eui-docgen/dist/components/breadcrumbs/breadcrumb';
import breadcrumbsDocgen from '@elastic/eui-docgen/dist/components/breadcrumbs';

<PropTable definition={breadcrumbDocgen.EuiBreadcrumb} />
<PropTable definition={breadcrumbsDocgen.EuiBreadcrumbs} />
